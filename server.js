...
io.sockets.on("connection", function (socket) {
  ...
  socket.on("send message", function (data) {
    ...
    var Trimetring =
      processedTime.getHours() + ":" + processedTime.getMinutes();
...
client.connect();
console.log(
  `Connecté à l'utilisateur [${pg_user}] dans la base [${pg_database}] sur le serveur [${pg_host}]`
);
...
const GOOGLE_CLIENT_ID =
  "1073321622517-6bthl55on8lpgp11btg32hcsss7vbot9.apps.googleusercontent.com";
