...
insert into users(login,password,email,firstname,lastname,dob,bankcard,address,mobile,genre,id_role,id_virtualaccount, id_prestataire) values
('admin', '$2b$10$21vNgcdjhDtj3RswzCk4kumHHOG2Iip30v3UnIK07SE.2lnaO6tv6','admin@gmail.com','firstname', 'lastname', '2003-04-11', null, null, '0605040302', 'homme',3, 1, null),
('admin2', '$2b$10$7hdYz80EO48vClKUI6EutuaTRyx9Vw8EQxnHayo9NDHmxmIDtusIO','admin2@gmail.com','firstname2', 'lastname2', '2019-01-02', null, 'address2', null, 'femme',3 ,2, null),
('user','$2b$10$PGRcCsacLXuDDa3de/mA2OPRxiMqc/SM031G2Hxm1MF69RhVB.Zje', 'user@user.com', 'firstnameuser', 'lastnameuser', '2003-04-11', null, null, null, 'homme', 1, 3, null),
('guest', '$2b$10$3mfmZUyyEy2QMDbyk91MzeIWmzWWGIfc1/o6ogZ8UzrFzdziFx0Ay', 'guest@guest.com', 'firstnameguest', 'lastnameguest', '1999-05-14', null, null, null, 'autre', 2, 4, 1);
...
('j''aime beaucoup ce qu''il fait, il ne l''a pas voler son titre de prestataire !', null, 1, 2),
('j''aime beaucoup ce qu''il fait, il ne l''a pas voler son titre de prestataire !', null, 2, 1);
...
(3,5,'2023-07-22','2023-07-26'),
(3,4,'2023-07-22','2023-07-25'),
(3,3,'2023-07-22','2023-07-24'),
(3,2,'2023-07-22','2023-07-23'),
(3,1,'2023-07-22','2023-07-22'),
(3,4,'2023-07-23','2023-07-26');
